...
namespace UrunSiparisYonetim
{
    public partial class MarkaYonetimi : Form
    {
        public MarkaYonetimi()
        {
            ...
            this.Resize += MarkaYonetimi_Resize;
            CenterControls();
        }

        private void MarkaYonetimi_Resize(object sender, EventArgs e)
        {
            CenterControls();
        }
        ...
        private void CenterControls()
        {
            ...
            int totalWidth = dgvMarkalar.Width + spacing + groupBox1.Width;
            ...
            // DataGridView Konumu
            dgvMarkalar.Left = startX;
            int dgvY = (this.ClientSize.Height - dgvMarkalar.Height) / 2;
            if (dgvY < 40) dgvY = 40; 
            dgvMarkalar.Top = dgvY;

            // GroupBox Konumu
            groupBox1.Left = dgvMarkalar.Right + spacing;
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Listeden Güncellenecek Kayıt Seçiniz!");
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                if (MessageBox.Show("Kaydı silmek istediğinize emin misiniz?", "Uyarı", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) 
                    == DialogResult.OK)
                {
            ...
            else MessageBox.Show("Listeden Silinecek Kayıt Seçiniz!");
        }
